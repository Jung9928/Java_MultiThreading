...
public class Main {
    ...
    public static class CoordinatedWorkRunner implements Runnable {
        ...
        private void task() throws InterruptedException {
            System.out.println(Thread.currentThread().getName() + " part 1 of the work is finsihed");

            barrier.barrier();

            System.out.println(Thread.currentThread().getName() + " part2 of the work is finished");
        }
    }
}
